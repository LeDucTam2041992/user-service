...
public class RedisCaffeineCacheManager implements CacheManager {
  ...
  public com.github.benmanes.caffeine.cache.Cache<Object, Object> caffeineCache() {
    ...
    if (cacheRedisCaffeineProperties.getCaffeine().getExpireAfterAccess() != null) {
      cacheBuilder.expireAfterAccess(
          cacheRedisCaffeineProperties.getCaffeine().getExpireAfterAccess());
    }
    if (cacheRedisCaffeineProperties.getCaffeine().getExpireAfterWrite() != null) {
      cacheBuilder.expireAfterWrite(
          cacheRedisCaffeineProperties.getCaffeine().getExpireAfterWrite());
    }
    ...
    if (cacheRedisCaffeineProperties.getCaffeine().getRefreshAfterWrite() != null) {
      cacheBuilder.refreshAfterWrite(
          cacheRedisCaffeineProperties.getCaffeine().getRefreshAfterWrite());
    }
